...
const BOT_IDENTITY = {
    ...
    currentDate: "2025-04-04 09:05:59",
    currentUser: "HuseyinYILDIZ-72",
...
function toggleSidebar() {
    ...
    if (window.innerWidth > 768) {
        if (sidebar.classList.contains('collapsed')) {
            mainChatArea.style.marginLeft = '0';
        } else {
...
async function sendMessage() {
    ...
    try {
        ...
        userMessageElement.classList.add('send-success');
        typingIndicator.remove();
...
// Input focus için viewport düzeltmesi
const input = document.getElementById('userInput');
